...
// Usage:
//   node playwright/playwright-client.js navigate <url>
//   node playwright/playwright-client.js screenshot <url> <output.png>
...
function usage(code = 0) {
  console.log("Usage:");
  console.log("  node playwright/playwright-client.js navigate <url>");
  console.log(
    "  node playwright/playwright-client.js screenshot <url> [output.png]"
  );
  console.log("\nEnvironment:");
